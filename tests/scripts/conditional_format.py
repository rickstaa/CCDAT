...
df1.to_excel(writer, sheet_name='Sheet1', header=False, index=False, startrow=start_row)
df2.to_excel(writer, sheet_name='Sheet3', header=False, index=False, startrow=start_row)
...
worksheet_1.conditional_format(start_row, start_column, end_row, end_col, {'type': 'formula',
                                       'criteria': '=Sheet2!A1="a"',
                                       'format': condition_format})
worksheet_3.conditional_format(start_row, start_column, end_row, end_col, {'type': 'formula',
                                       'criteria': '=Sheet2!B1="a"',
                                       'format': condition_format})
