""" Conditional csv data analyse Tool (CCDAT)
    This tool was created for a friend of mine to help him with the data analysis he had to
    do for his graduation project. It is is licences under a MIT Creative common licence.

    Author: Rick Staa
    Maintainer: Wesley Bosman
...
class DataAnalyserGUI(Ui_MainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        ### Link input file choice button signal to slot ###
        self.input_file_browser_btn.clicked.connect(self.get_input_file)

        ### Link out file choice button signal to slot###
    ...
    def get_output_dir(self):
        '''Qt slot function created to get a user specified output folder. It is linked to the output_file_browser_btn and displays a
        ...
        #################################################
            ...
            #################################################
                ...
                for condition_text in self.condition_line_edit:
                    ...
                    ### Perform data analysis using the specified conditional expressions ###
                    try:
