...
# Create paths
SPHINX_AUTO_RST_PATH = os.path.abspath(
    os.path.join(DIRNAME_ONE_UP, "docs/source/_auto_rst")
).replace("\\", "/")
...
if __name__ == "__main__":
    ...
    ## Build documentation ###
    subprocess.call(
        ["sphinx-apidoc", "-o", SPHINX_AUTO_RST_PATH, CGDAT_PACKAGE_PATH]
    )  # Run autodocumentation
    subprocess.call(
        ["sphinx-apidoc", "-o", SPHINX_AUTO_RST_PATH, SCRIPTS_FOLDER_PATH]
    )  # Run autodocumentation
