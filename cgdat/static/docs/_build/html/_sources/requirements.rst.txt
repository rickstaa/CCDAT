...
For the program to run the following packages and software needs to be installed on the computer. When using the :samp:`installer` these are automatically isntalled.
