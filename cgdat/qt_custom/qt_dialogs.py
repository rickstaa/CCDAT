...
#####################################################################
class progressDialog(QtWidgets.QDialog, qt_ui.Ui_ProgressDialog):
    """This class overloads the qt python class that was generated by yQt5.uic.pyuic
    converter for the progressDialog so it can be used as a dialog in our main GUI.
    ...
    def __init__(self, parent=None):
        ...
        QtWidgets.QDialog.__init__(
            self, parent, QtCore.Qt.WindowSystemMenuHint | QtCore.Qt.WindowTitleHint
        )
        self.setupUi(self)
    ...
    def updateProgressBar(self, percentage):
        ...
        if percentage == 100.0:
            self.buttonBox.removeButton(
                self.buttonBox.button(QtWidgets.QDialogButtonBox.Cancel)
...
#####################################################################
class importDialog(QtWidgets.QDialog, qt_ui.Ui_ImportDialog):
    """This class overloads the qt python class that was generated by yQt5.uic.pyuic
    converter for the importDialog so it can be used as a dialog in our main GUI.
...
#####################################################################
# Overload custom splash screen Dialog class ########################
#####################################################################
class splashDialog(QtWidgets.QDialog, qt_ui.Ui_splash_screen):
    """This class overloads the qt python class that was generated by yQt5.uic.pyuic
    converter for the splash screen dialog so it can be used as a dialog in our main
    GUI.
...
#####################################################################
class outputSettingsDialog(QtWidgets.QDialog, qt_ui.Ui_OutputSettings):
    """This class overloads the qt python class that was generated by yQt5.uic.pyuic
    converter for the output_settings_ui so it can be used as a dialog in our main GUI.
    ...
    def __init__(self, parent=None):
        ...
        sizePolicy.setHeightForWidth(
            self.column_choicer_drop_down_menu.sizePolicy().hasHeightForWidth()
        )
        self.column_choicer_drop_down_menu.setSizePolicy(sizePolicy)

        # self.column_choicer_drop_down_menu.font(10)
        self.additional_output_settings_grid.addWidget(
            self.column_choicer_drop_down_menu, 0, 2, 1, 1
        )
        self.column_choicer_drop_down_menu.setText(
            "Please import a data file to see the available columns"
        )
