...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(
            QtGui.QPixmap("../media/CGDAT.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
        ...
        self.time_range_value = QtWidgets.QDoubleSpinBox(
        ...
        sizePolicy.setHeightForWidth(
            self.time_range_value.sizePolicy().hasHeightForWidth()
        )
        ...
        self.player_filter_toggle = QtWidgets.QCheckBox(
            self.additional_options_groupbox
        )
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.time_selection_file_label = QtWidgets.QLabel(
            self.additional_options_groupbox
        )
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.additional_options_layout.addWidget(
            self.time_selection_file_label, 0, 1, 1, 1
        )
        ...
        self.time_file_browser_btn = QtWidgets.QToolButton(
            self.additional_options_groupbox
        )
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.control_group_box.sizePolicy().hasHeightForWidth()
        )
        self.control_group_box.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.control_group_box.setFont(font)
        self.control_group_box.setStyleSheet(
            "QGroupBox{padding-top:0px; margin-top:0px}"
        )
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(
            QtGui.QPixmap("../media/settings_icon.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.conditions_group_box.sizePolicy().hasHeightForWidth()
        )
        ...
        self.output_data_folder_label = QtWidgets.QLabel(
            self.general_settings_group_box
        )
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.general_settings_layout.addWidget(
            self.output_data_folder_label, 1, 0, 1, 1
        )
        ...
        self.input_file_browser_btn = QtWidgets.QToolButton(
            self.general_settings_group_box
        )
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.output_file_browser_btn = QtWidgets.QToolButton(
            self.general_settings_group_box
        )
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(
            QtGui.QPixmap("../media/about_icon.png"),
            QtGui.QIcon.Normal,
            QtGui.QIcon.Off,
        )
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(
            QtGui.QPixmap("../media/docs.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off
        )
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.additional_options_groupbox.setTitle(
            _translate("MainWindow", "Additional options")
        )
        self.time_file_path.setToolTip(
            _translate(
                "MainWindow",
                "<html><head/><body><p>Here you have the possibility to add a file containing time points at which you want to analyse the data.</p></body></html>",
            )
        )
        self.time_range_value.setToolTip(
            _translate(
                "MainWindow",
                "<html><head/><body><p>Here you define how many seconds you want to include in your analysis before and after a given condition is met.</p></body></html>",
            )
        )
        ...
        self.time_selection_file_label.setText(
            _translate("MainWindow", "Use time section file")
        )
        ...
        self.analyse_data_btn.setToolTip(
            _translate("MainWindow", "Start data analysis.")
        )
        self.analyse_data_btn.setText(_translate("MainWindow", "Analyse Data"))
        self.reset_conditions_grid_btn.setToolTip(
            _translate("MainWindow", "Reset conditions.")
        )
        self.reset_conditions_grid_btn.setText(
            _translate("MainWindow", "Reset conditions")
        )
        self.output_settings_btn.setToolTip(
            _translate("MainWindow", "Additional result output file options.")
        )
        ...
        self.output_data_folder_label.setText(
            _translate("MainWindow", "Results output folder")
        )
        self.input_data_label.setText(_translate("MainWindow", "Input data file"))
        self.output_file_path.setToolTip(
            _translate(
                "MainWindow",
                "<html><head/><body><p>Here you define the output location of the file containing the data analysis.</p></body></html>",
            )
        )
        self.input_file_browser_btn.setText(_translate("MainWindow", "..."))
        self.output_file_browser_btn.setText(_translate("MainWindow", "..."))
        self.input_file_path.setToolTip(
            _translate(
                "MainWindow",
                "<html><head/><body><p>Here you define the data file you want to analyse.</p></body></html>",
            )
        )
