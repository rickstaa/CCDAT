...
icon_path = os.path.abspath(os.path.join(dirname, '..', "media/cgdat_new.ico")).replace('\\','/')    # Toggle on icon
cgdat_path = os.path.abspath(os.path.join(dirname, '..', "cgdat/cgdat.py")).replace('\\','/')    # Toggle on icon
...
if __name__ == '__main__':
    ...
    python_exe_path = re.sub(r'\\python.exe', '', python_exe)
    pythonw_exe_path = python_exe_path + r"\\pythonw.exe"
